// Hero.jsx — clean hero, waitlist only, no mock
function Hero() {
  return (
    <section className="twg-hero" id="hero-waitlist">
      ...
      <div className="twg-container">
        <div className="twg-hero-photo-strip">
          {[
            { src:'../../uploads/Maddie%20Soccer.jpg',    pos:'center 50%' },
            { src:'../../uploads/Aiden%20Football.jpg',   pos:'center center' },
            { src:'../../uploads/Maddie%202.jpg',         pos:'center 60%' },
          ].map(({ src, pos }, i) => (
...
function WaitlistForm() {
  ...
  const submit = (e) => {
    e.preventDefault();
    if (email) {
      // In production: wire to email service, then redirect to thank-you page
...
window.WaitlistConfirmed = WaitlistConfirmed;
